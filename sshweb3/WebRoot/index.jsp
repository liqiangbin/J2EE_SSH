...
<script>
    BUI.use('admin/common/main',function(){
        ...
        {id:'7',homePage : '9',menu:[{text:'教工信息',items:[
        {id:'9',text:'教工信息',href:'teaAction_showPage.action?page=1'},
        {id:'8',text:'修改密码',href:'admin/Person/index.jsp'},
        {id:'10',text:'学期设置',href:'admin/term/term.jsp'},
