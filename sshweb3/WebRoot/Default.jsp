...
<%
       ...
       /*  doc.getTemplate().defineDataRegion("Name", "[ 姓名 ]");
        ...
        poCtrl.addCustomToolButton("确认保存并上传", "Save()", 1);
       // poCtrl.addCustomToolButton("定义数据区域", "ShowDefineDataRegions()", 3);%>
<a href="index.jsp">tijiao</a>
        ...
        String address=(String)session.getAttribute("outlineview");
        poCtrl.webOpen(address, OpenModeType.docNormalEdit, "zhangsan");
