...
<% List<Teacher> teacher=(List<Teacher>)session.getAttribute("teacher"); %>
   <table class="table table-bordered table-hover definewidth m10">
	...
	<thead>
	<form action="teachingprogressAction_findByTerm?teachingprogress.tid=<%=teacher.get(0).getId()%>" method="post">
	<tr>
		<th colspan="3">
		选择学期：
	<select name="teachingprogress.term">
	<option>显示所有</option>
    ...
    <% List<Teachingprogress> outline=(List<Teachingprogress>)session.getAttribute("oneTeacherTeaching"); 
    %>
